...
Note that with covariates in the model, the standard errors above are systematically smaller for distal outcome estimation than if there were no covariates in the model (see below).
